...
export function PlayerControls({
  ...
  return (
    <div
      className={`relative z-30 w-full max-w-xl mx-auto pb-6 sm:pb-8 px-4 shrink-0 flex flex-col items-center gap-3 transition-opacity duration-500 ${
        isVisible ? 'opacity-100 pointer-events-auto' : 'opacity-0 pointer-events-none'
      }`}
    >
      {/* Floating Control Bar */}
      <div className="bg-stone-950/85 backdrop-blur-2xl border border-white/20 rounded-full px-6 py-2 flex items-center justify-between gap-6 shadow-2xl shadow-black/80 w-full">
        <button
          onClick={onPrevTrack}
        ...
        <button
          ...
          className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-white text-stone-950 flex items-center justify-center hover:scale-105 active:scale-95 transition-all shadow-lg shadow-white/20"
        ...
        <button className="p-1 rounded-full text-white/70 hover:text-white transition-colors" title="AirPlay">
